...
def show_pose(image, pose, true_image, ignore_joints=None):
    ...
    for i, j in [(0, 1), (1, 2), (3, 4), (4, 5), (6, 7), (7, 8), (9, 10), (10, 11), (8, 12), (9, 12), (12, 13), (3, 12),
                 (2, 12)]:
        if ignore_joints is None:
            plt.plot([pose[i][0] * image_size, pose[j][0] * image_size],
                     [pose[i][1] * image_size, pose[j][1] * image_size], '-o', lw=2)
        else:
